...
class NewPorjectAmenities(DatedModel):
...
class NewProjects(DatedModel):
    ...
    city = models.OneToOneField(City, on_delete=models.CASCADE, null=True, blank=True)
    ...
    amenities = models.OneToOneField(NewPorjectAmenities, on_delete=models.CASCADE, null=True, blank=True)
    available_units = models.OneToOneField(Bed, on_delete=models.CASCADE, null=True, blank=True)
...
class Media(DatedModel):
    ...
    new_project = models.ForeignKey(NewProjects, related_name="property_media", on_delete=models.CASCADE, null=True, blank=True)

# Generated by Django 4.2.1 on 2023-09-22 18:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('floor_plan_img', models.ImageField(blank=True, null=True, upload_to='bed_floor_plans/')),
            ],
        ),
        migrations.CreateModel(
            name='UnitType',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('project_types', models.CharField(blank=True, choices=[('upcoming', 'UpComing'), ('underconstruction', 'UnderCostruction'), ('completed', 'Completed')], default='upcoming', max_length=20, null=True)),
                ...
                ('city', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='property.city')),
                ...
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='property.country')),
                ...
                ('property_type', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='project_property_types', to='property.propertytypes')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='project_media', to='new_projects.projects')),
            ],
            options={
                'abstract': False,
            },
